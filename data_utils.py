...
def load_music_utils(filename):
    chords, abstract_grammars = get_musical_data(filename)
...
def generate_music(inference_model, indices_tones, chords, outfile = "output/my_music.midi", \
    ...
    mf.open(outfile, 'wb')
    mf.write()
    print("Your generated music is saved in %s" % outfile)
    mf.close()
